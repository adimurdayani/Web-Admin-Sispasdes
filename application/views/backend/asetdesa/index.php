        ...
        <div class="card-box">
          ...
          <div class="table-responsive">
            <table class="table table-hover mb-0">
              ...
              <tbody>
                <?php $no = 1; foreach($get_aset as $data):?>
                <tr>
                  ...
                  <td class="text-center">
                    <a href="" class="badge badge-warning" data-target="#edit-modal<?= $data['id_aset']?>"
                      data-toggle="modal"><i class="fe-edit" title="Edit"></i></a>
                    <a href="" class="badge badge-danger" data-target="#hapus-modal<?= $data['id_aset']?>"
      ...
      <form method="POST" action="<?= base_url('backend/asetdesa')?>" class="needs-validation" novalidate>
        ...
        <div class="modal-body">
          ...
          <div class="form-group mb-3">
            ...
            <input type="text" class="form-control" name="nama_aset" id="nama_aset" placeholder="Enter nama aset"
              required>
          ...
          <div class="form-group mb-3">
            ...
            <input type="number" class="form-control" name="harga" id="harga" placeholder="Enter harga Rp.100.000"
              required>
            <div class="invalid-feedback">
          ...
          <div class="form-group mb-3">
            ...
            <input type="number" class="form-control" name="jml_aset" id="jml_aset" placeholder="Enter jumlah aset"
              required>
            <div class="invalid-feedback">
...
<div id="edit-modal<?= $edit['id_aset']?>" class="modal fade" tabindex="-1" role="dialog"
    ...
    <div class="modal-content">
      <form method="POST" action="<?= base_url('backend/asetdesa/edit')?>" class="needs-validation" novalidate>
        ...
        <div class="modal-body">
          ...
          <div class="form-group mb-3">
            <label for="nama_aset">Nama Aset</label>
            <input type="text" class="form-control" name="nama_aset" id="nama_aset" value="<?= $edit['nama_aset']?>"
              placeholder="Enter nama aset" required>
            <div class="invalid-feedback">
              Nama aset tidak boleh kosong.
            </div>
          </div>
          <div class="form-group mb-3">
            <label for="harga">Harga Sewa Aset</label>
            <input type="number" class="form-control" name="harga" id="harga" value="<?= $edit['harga']?>"
              placeholder="Enter harga Rp.100.000" required>
            <div class="invalid-feedback">
              Harga aset tidak boleh kosong.
            </div>
          </div>
          ...
          <div class="form-group mb-3">
            <label for="jml_aset">Jumlah Aset</label>
            <input type="number" class="form-control" name="jml_aset" id="jml_aset" value="<?= $edit['jml_aset']?>"
              placeholder="Enter jumlah aset" required>
            <div class="invalid-feedback">
              Jumlah aset tidak boleh kosong.
            </div>
          </div>
...
<div id="hapus-modal<?= $edit['id_aset']?>" class="modal fade" tabindex="-1" role="dialog"
  aria-labelledby="standard-modalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <form method="POST" action="" class="needs-validation" novalidate>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-light" data-dismiss="modal">Tutup</button>
          <a href="<?= base_url('backend/asetdesa/hapus/') . $hapus['id_aset']?>" class="btn btn-danger"> <i
