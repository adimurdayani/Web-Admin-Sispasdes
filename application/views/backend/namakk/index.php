        ...
        <div class="card-box">
          ...
          <div class="table-responsive">
            <table id="basic-datatable" class="table dt-responsive nowrap w-100">
              ...
              <tbody>
                <?php $no = 1; foreach($get_namakk as $data):?>
                <tr>
                  ...
                  <td class="text-center">
                    <a href="" class="badge badge-warning" data-target="#edit-modal<?= $data['id_kk']?>"
                      data-toggle="modal"><i class="fe-edit" title="Edit"></i></a>
                    <a href="" class="badge badge-danger" data-target="#hapus-modal<?= $data['id_kk']?>"
...
<div id="edit-modal<?= $edit['id_kk']?>" class="modal fade" tabindex="-1" role="dialog"
    ...
    <div class="modal-content">
      <form method="POST" action="<?= base_url('backend/namakk/edit')?>" class="needs-validation" novalidate>
        ...
        <div class="modal-body">
          ...
          <div class="form-group mb-3">
            <label for="nama_kk">Nama KK</label>
            <input type="text" class="form-control" name="nama_kk" id="nama_kk" value="<?= $edit['nama_kk']?>"
...
<div id="hapus-modal<?= $hapus['id_kk']?>" class="modal fade" tabindex="-1" role="dialog"
  aria-labelledby="standard-modalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-light" data-dismiss="modal">Tutup</button>
        <a href="<?= base_url('backend/namakk/hapus/') . $hapus['id_kk']?>" class="btn btn-danger"><i
