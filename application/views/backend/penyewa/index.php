...
<div class="content-page">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <table id="basic-datatable" class="table dt-responsive nowrap w-100">
                ...
                <tbody>
                  <?php $no = 1; foreach($get_penyewa as $data):?>
                  <tr>
                    <td><?= $no++;?></td>
                    <td><?= $data['nama']?></td>
                    ...
                    <td>
                      ...
                      <a href="" data-target="#status-modal<?= $data['id_penyewa']?>" data-toggle="modal"
                        class="badge badge-success">Terkonfirmasi</a>
                      <?php else:?>
                      <a href="" data-target="#status-modal<?= $data['id_penyewa']?>" data-toggle="modal"
                        class="badge badge-warning">Belum terkonfirmasi</a>
                      <?php endif;?>
                    </td>
                    <td><?= $data['created_at']?></td>
                    <td><?= $data['tgl_kembali']?></td>
                    <td class="text-center">
                      <a href="" class="badge badge-danger" data-target="#hapus-modal<?= $data['id_penyewa']?>"
  ...
  <div id="hapus-modal<?= $hapus['id_penyewa']?>" class="modal fade" tabindex="-1" role="dialog"
  ...
  <div id="status-modal<?= $status['id_penyewa']?>" class="modal fade" tabindex="-1" role="dialog"
    aria-labelledby="standard-modalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
